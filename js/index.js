...
for(let i=0; i<h4main.length; i++) {
  for(let n=0; n<Object.values(objMain).length; n++) {
    n%2 ==0 ? h4main[i].innerHTML = Object.values(objMain)[n] : p[i].innerHTML = Object.values(objeMain)[n]
  }
}
...
contact.querySelectorAll("p").forEach((a,b) => {
  return a.innerHTML = Object.values(siteContent["contact"])[b + 1]
})
